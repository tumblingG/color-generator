(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ColorGeneratorComponent = /** @class */ (function () {
                function ColorGeneratorComponent(colorService) {
                ...
                ColorGeneratorComponent.prototype.onColorChange = function (ev) {
                    var _this = this;
                    var colorProperty = ev.property;
                    var colorValue = ev.value;
                    var colorIndex = this.colors.findIndex(function (o) { return o.property === colorProperty; });
                    var color = this.colors[colorIndex];
                    var genColor = Object(_parse_css__WEBPACK_IMPORTED_MODULE_3__["generateColor"])(color.name, colorProperty, colorValue);
                    ...
                    Object.keys(attrMap).forEach(function (key) {
                        _this.cssText = Object(_parse_css__WEBPACK_IMPORTED_MODULE_3__["updateCssText"])(colorProperty + attrMap[key], _this.cssText, genColor[key]);
                    });
                    this.demoMessage.emit({ cssText: this.cssText });
                };
                ColorGeneratorComponent.prototype.onCssTextChange = function (ev) {
                    this.cssText = ev;
                    var colors = Object(_parse_css__WEBPACK_IMPORTED_MODULE_3__["convertCssToColors"])(this.cssText);
                    if (colors.length > 0) {
                        this.colors = colors;
                        this.demoMessage.emit({ cssText: this.cssText });
                    }
                };
                ColorGeneratorComponent.prototype.observeNameOrColorChange = function () {
                    var _this = this;
                    this.colorService.onNameOrColorChange.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroy$))
                        ...
                        if (type === 'color') {
                            _this.onColorChange(data);
                            _this.selectColor = _this.colors.find(function (item) { return item.value === data.value; });
                        }
                        else if (type === 'cssText') {
                            _this.onCssTextChange(data);
                        }
                        else { }
                    });
                };
                ColorGeneratorComponent.prototype.onActiveColorChange = function (color) {
                    this.selectColor = color;
                };
                ColorGeneratorComponent.prototype.ngOnInit = function () {
                ...
                ColorGeneratorComponent.prototype.ngAfterViewInit = function () {
                    this.demoMessage.emit({ cssText: this.cssText });
                };
                return ColorGeneratorComponent;
            }());
            ColorGeneratorComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ColorService = /** @class */ (function () {
                ...
                Object.defineProperty(ColorService.prototype, "onNameOrColorChange", {
                    get: function () {
                        return this.subject;
                    },
                    enumerable: true,
                ...
                ColorService.prototype.changeName = function (data) {
                    this.subject.next({
                        type: 'name',
                        data: data
                    });
                };
                ColorService.prototype.changeColor = function (data) {
                    this.subject.next({
                        type: 'color',
                        data: data
                    });
                };
                ColorService.prototype.changeCssText = function (data) {
                    this.subject.next({
                        type: 'cssText',
                        data: data
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CssTextComponent = /** @class */ (function () {
                function CssTextComponent(colorService) {
                    this.colorService = colorService;
                    this.showCopyConfirmation = false;
                    this.cssText = '';
                    this.header = true;
                }
                CssTextComponent.prototype.onCssTextChange = function (ev) {
                ...
                CssTextComponent.prototype.copyCssText = function (ev) {
                    var _this = this;
                    ev.preventDefault();
                    this.showCopyConfirmation = true;
                    var cssEl = this.cssTextEl.nativeElement;
                    var cssText = cssEl.textContent || '';
                    ...
                    var timer = setTimeout(function () {
                        clearTimeout(timer);
                        _this.showCopyConfirmation = false;
                    }, 2000);
                };
                CssTextComponent.prototype.ngOnInit = function () {
                };
                return CssTextComponent;
            }());
            CssTextComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MyButtonComponent = /** @class */ (function () {
                ...
                MyButtonComponent.prototype.setBackgroundColor = function (color) {
                    this.btn.nativeElement.style.backgroundColor = color;
                };
                MyButtonComponent.prototype.onEnter = function () {
                    this.isHover = true;
                    this.setBackgroundColor(this.color.tint);
                };
                MyButtonComponent.prototype.onLeave = function () {
                    this.isHover = false;
                    this.setBackgroundColor(this.color.value);
                };
                MyButtonComponent.prototype.onMouseDown = function () {
                    this.setBackgroundColor(this.color.shade);
                };
                MyButtonComponent.prototype.onMouseUp = function () {
                    if (this.isHover) {
                        this.setBackgroundColor(this.color.tint);
                    }
                    else {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            function generateColor(name, property, value) {
                var color = new _color__WEBPACK_IMPORTED_MODULE_2__["Color"](value);
            ...
            function convertCssToColors(cssText) {
                var colors = [];
                _color_variables__WEBPACK_IMPORTED_MODULE_1__["COLOR_VARS"].forEach(function (colorVar) {
                    var attrMap = {
                        value: '',
                        valueRgb: '-rgb',
                        contrast: '-contrast',
            ...
            function getCssKeyVal(colorAttr, cssText) {
                ...
                var endIndex = startIndex + colorAttr.length + semiColonIndex;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var SelectColorsComponent = /** @class */ (function () {
                function SelectColorsComponent() {
                    this.activeColor = '';
                    this.colors = [];
                    this.onActiveChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                }
                SelectColorsComponent.prototype.toggleActiveColor = function (name) {
                    if (this.activeColor === name) {
                        this.activeColor = '';
                        return;
                    }
                    this.activeColor = name;
                    var selectColor = this.colors.find(function (item) { return item.name === name; });
                    this.onActiveChange.emit(selectColor);
                };
                SelectColorsComponent.prototype.ngOnInit = function () {
                };
                return SelectColorsComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _color_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../color.service */ "./src/app/color.service.ts");
            var VariableSelectorComponent = /** @class */ (function () {
                function VariableSelectorComponent(colorService) {
                    this.colorService = colorService;
                ...
                VariableSelectorComponent.prototype.onNameChange = function (ev) {
                ...
                VariableSelectorComponent.prototype.onColorInputChange = function (color) {
                    this.colorService.changeColor({
                        property: this.property,
                        value: color
                    });
                };
                VariableSelectorComponent.prototype.onColorTextInputChange = function (color) {
                    var val = color.trim();
                    if (val[0] !== '#') {
                        val = '#' + val;
                    }
                ...
                VariableSelectorComponent.prototype.onValueInputFocus = function () {
                    this.isValueInputFocused = true;
                };
                VariableSelectorComponent.prototype.onValueInputBlur = function (ev) {
                    var input = ev.currentTarget;
                    this.value = input.value.trim();
                    this.isValueInputFocused = false;
                };
                VariableSelectorComponent.prototype.onNameInputFocus = function () {
                    this.isNameInputFocused = true;
                };
                VariableSelectorComponent.prototype.onNameInputBlur = function (ev) {
                    var input = ev.currentTarget;
                    this.name = input.value.trim();
                    this.isNameInputFocused = false;
                };
                VariableSelectorComponent.prototype.isValidName = function (str) {
                    return /^[A-Z\-\_]+$/i.test(str);
                };
                VariableSelectorComponent.prototype.validateName = function () {
                    var isValidName = this.isValidName(this.name);
                    this.showNameError = (isValidName && this.name.length > 0) ? false : true;
                };
                VariableSelectorComponent.prototype.isValidHex = function (str) {
                    return /^#[0-9A-F]{6}$/i.test(str);
                };
                VariableSelectorComponent.prototype.validateValue = function () {
                    var isValidHex = this.isValidHex(this.value);
                    this.showValueError = (isValidHex && this.value.length === 7) ? false : true;
                };
                VariableSelectorComponent.prototype.onValueInputParentClick = function (ev) {
                    if (this.isParentOpen) {
                        ev.stopPropagation();
                    }
                };
                VariableSelectorComponent.prototype.ngOnInit = function () {
                    this.validateName();
                    this.validateValue();
                    this.inputValue = this.value;
                };
                return VariableSelectorComponent;
            }());
            VariableSelectorComponent.ctorParameters = function () { return [
                { type: _color_service__WEBPACK_IMPORTED_MODULE_2__["ColorService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
